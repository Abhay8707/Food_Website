        ...
        <div className='px-5 lg:px-20'>
            <section>
                <h3 className='text-gray-500 py-2 mt-10'>
                    {`Home/india/Insta Resturant/2/Order Online`}
                </h3>
                <div>
                    <img className='w-full h-[40vh] object-cover' src="https://cdn.pixabay.com/photo/2017/01/26/02/06/platter-2009590_640.jpg" alt="" />
                </div>
                <div>
                    <h1 className='text-4xl py-1 font-semibold'>{`Insta Restaurant`}</h1>
